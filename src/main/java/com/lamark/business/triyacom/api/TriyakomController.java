...
//        Instant start = Instant.now();
        ...
        data.setTid(tid);
        logger.info("[DELIVERY][REQUEST]: {}", data);
        Uni.createFrom().item(data).emitOn(Infrastructure.getDefaultWorkerPool()).subscribe()
                .with(triyacomService::delivery, Throwable::printStackTrace);
